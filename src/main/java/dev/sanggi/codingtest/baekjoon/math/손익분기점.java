package dev.sanggi.codingtest.baekjoon.math;
...
public class 손익분기점 {
    ...
    public static void main(String[] args) {
        ...
        final int A = Integer.parseInt(arr[0]), B = Integer.parseInt(arr[1]), C = Integer.parseInt(arr[2]);
        int soldCount;
        ...
        if (soldCount <= 0) System.out.print("-1");
        else System.out.print(soldCount);
    }
}
